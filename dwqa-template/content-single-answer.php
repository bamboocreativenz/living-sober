...
<div class="<?php echo dwqa_post_class() ?>" id="answer-<?php the_ID() ?>">
	...
	<div class="dwqa-answer-meta">
		...
		<?php printf( __( '<span><a href="%1$s">%2$s%3$s</a> %4$s answered %5$s ago</span>', 'dwqa' ), bp_core_get_user_domain( $user_id ), get_avatar( $user_id, 48 ), get_the_author(), dwqa_print_user_badge( $user_id ), human_time_diff( get_post_time( 'U', true ) ) ) ?>
